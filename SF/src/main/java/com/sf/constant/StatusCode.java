...
/**
 * StatusCode class contains constants representing various status codes
 * used throughout the application, along with their corresponding messages.
 */
public class StatusCode {

  // Define status codes with appropriate indentation
  ...
  // Initialize messages with appropriate indentation
   ...
   * @return the message corresponding to the status code, or "未知错误" if the code is not found
   */
